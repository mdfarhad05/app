import 'package:app/model/recentmatches_model.dart' as myAppModel;
...
class Recentmatches extends StatelessWidget {
  ...
  Future recentmatchesfetchData() async {
    final headers = {
    ...
    return Scaffold(
      ...
      body: Center(
        child: ElevatedButton(
          onPressed: () {
            recentmatchesfetchData();
          },
          child: const Text('Recent matches'),
        ),
      ),
    );
  }
